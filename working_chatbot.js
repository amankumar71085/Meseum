...
function speakMessage(text) {
    ...
    const selectedVoice = voices.find(voice => voice.name === 'Microsoft Neerja Online (Natural) - English (India)');
...
function botResponse(userInput) {
    ...
    if (step === 1) {
        ...
        if (userInput === "yes") {
            ...
            .then(data => {
                addMessage(`Booking successful! Your booking ID is ${data.bookingId}.`, "botMessage");
